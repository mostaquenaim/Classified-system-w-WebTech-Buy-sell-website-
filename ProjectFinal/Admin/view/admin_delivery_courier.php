...
if(isset($_GET["id"]))
{
    ...
    $mydb->deleteRow($myconn,'delivery_courier',$id);

     header("Location: admin_delivery_courier.php");
}
?>
<html>
...
<form>
<h2><center>Courier delivery Listings</center></h2>
<hr size="2" width="100%">
...
{
  echo "<table><tr><th>Serial</th><th>Name</th><th>address</th><th>mobile</th><th>product</th><th>delivered?</th></tr>";
