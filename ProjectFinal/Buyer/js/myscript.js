...
else if(fnamecheck.match(letters))
{
...
function formcheck(){
    if(fnamecheck() && emailcheck() && passcheck() &&  dobcheck() && lnamecheck() &&  unamecheck() &&  mobilecheck && conpasscheck() && gencheck() && filecheck() && checkbox()){
        return true;
    }
    else{
    ...
    function formcheck2(){
        if(fnamecheck() && passcheck() && emailcheck() && dobcheck() && lnamecheck&& unamecheck() &&  mobilecheck() && conpasscheck() && filecheck()){
            return true;
        }
        else{
            document.getElementById("write").innerHTML="Fill up everthing";
